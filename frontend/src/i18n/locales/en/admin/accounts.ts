export default {
    accounts: {
      ...
      usageWindow: {
        ...
        grokCredits: 'Credits',
        grokMonthlyCredits: 'Monthly credits',
        grokPayAsYouGo: 'Pay-as-you-go',
        grokPrepaidCredits: 'Prepaid',
        grokExtraUsageCredits: 'Extra credits',
        grokCreditRemaining: 'remaining',
        grokCreditLimit: 'limit',
        grokCreditUsed: 'used',
